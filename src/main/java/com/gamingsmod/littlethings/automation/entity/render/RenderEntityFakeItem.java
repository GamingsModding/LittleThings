package com.gamingsmod.littlethings.automation.entity.render;
...
public class RenderEntityFakeItem implements IRenderFactory<EntityFakeItem>
{
    @Override
    public Render<? super EntityFakeItem> createRenderFor(RenderManager manager)
    {
        return new Render<EntityFakeItem>(manager)
        {
            private final RenderItem itemRenderer = Minecraft.getMinecraft().getRenderItem();
            private final Random random = new Random();

            private int transformModelCount(EntityFakeItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
            {
             ...
             */
            @Override
            public void doRender(EntityFakeItem entity, double x, double y, double z, float entityYaw, float partialTicks)
            {
             ...
             */
            @Override
            protected ResourceLocation getEntityTexture(EntityFakeItem entity)
            {
