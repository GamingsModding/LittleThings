...
public class CommandTeleportDim extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
         ...
         * /tpdim RageGamingPE GingerMikie - Teleport RageGamingPE to GingerMikie
         */
        if (args.length > 5)
        ...
        if (NumberUtils.isNumber(args[0])) {
            ...
            if (args.length == 1) {
                ...
                notifyCommandListener(sender, this, "command.littlethings.tpdim.success.player", host.getDisplayNameString(), recp.getDisplayNameString());
    ...
    private Entity teleportPlayerToDim(World oldWorld, int newWorldID, double d, double e, double f, Entity entity)
    {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            if (!player.worldObj.isRemote) {
                ...
                player.connection.sendPacket(new SPacketRespawn(player.dimension, player.worldObj.getDifficulty(), newWorldServer.getWorldInfo().getTerrainType(), player.interactionManager.getGameType()));
                ...
                player.connection.setPlayerLocation(d, e, f, entity.rotationYaw, entity.rotationPitch);
